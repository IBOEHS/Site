...
<head>
  ...
  <title>IBOEHS - STUDENTS SAYS</title>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                <div class="testi-wrap">
                    <!--<div class="img-part">-->
                    <!--    <img src="images/says/2.jpg" alt="">-->
                    <!--</div>-->
                    <div class="content-part new-content pt-12">
                        <div class="desc">" IBOEHS RSP program is one of the rarest qualifications every Safety professional must undergo. The content of the programs is so rich, and it provides extensive knowledge "</div>
                        <div class="info">
                            <h5 class="name">Jean Theodore </h5>
                            <div class="designation">Cameroon</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                <div class="testi-wrap">
                    ...
                    <!--</div>-->
                    <div class="content-part new-content pt-12">
                        <div class="desc">" IBOEHS- OSHA General Industry Standards program is one of the best safety programs I have attended recently. I would recommend this course for all safety officers "</div>
                        <div class="info">
                            <h5 class="name">Ms.Zong Tesmani  </h5>
                            <div class="designation">Kuwait</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                <div class="testi-wrap">
                    ...
                    <!--</div>-->
                    <div class="content-part new-content pt-12">
                        <div class="desc">" IBOEHS - OSHA construction Industry standards are better than any present-day International expensive safety courses. I am fortunate to avail this program "</div>
                        <div class="info">
                            <h5 class="name">Ms.Rosemary   </h5>
                            <div class="designation">Nigeria</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                <div class="testi-wrap">
                    ...
                    <!--</div>-->
                    <div class="content-part new-content pt-12">
                        <div class="desc">" IThe train the trainer program of IBOEHS is entirely different from any other train the trainer program. It is, in fact, a full-fledged leadership program teaching how to lead your trainees in a training session—genuinely motivating."</div>
                        <div class="info">
                            <h5 class="name">Emmanuel </h5>
                            <div class="designation">Botswana</div>
                        </div>
                    </div>
                </div>
            </div>
