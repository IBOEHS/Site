...
<head>
  ...
  <title>IBOEHS - Our Policies</title>
...
<!--        As a leading International skill certifying body, IBOSD is aware of the impact that its activity has on its employees, customers, and partners with which it interacts. It has encouraged us to develop our policies that reﬂects the values and expectations of our employees, our customers, and the stakeholders in general.-->
<!--        <br><br>-->
<!--        By implementing the new editions of the 9001:2015 standard, IBOSD has formalized its policy focuses under various categories to understand better and meet the expectations of those concerned while implementing activities that can bring desired changes and growth.-->
<!--         IBOSD insists all staff that works for and on behalf of the Organization communicate, implement, maintain and document its policies. Our policies are regularly revised and updated and made publicly available on the website and corporate intranet website.-->
        
<!--    </p>-->

<!--    <h3 class="page-sub-title"> The policy of IBOSD, therefore, aims to achieve the following objectives: </h3>-->
<!--    <ul class="faq-list list-unstyled">-->
<!--        <li><i class="fa fa-angle-right"></i>  	Customer Satisfaction;</li>-->
<!--        <li><i class="fa fa-angle-right"></i>  	The motivation and development of Human Resources;</li>-->
<!--        <li><i class="fa fa-angle-right"></i> 	Protection of its own and its customers' information and data through conformity to the requirements of Confidentiality, Integrity, and Availability; </li>-->
<!--        <li><i class="fa fa-angle-right"></i>  	Promote Diversity within the Organization </li>-->
<!--        <li><i class="fa fa-angle-right"></i>  	Compliance with legal requirements </li>-->
<!--        <li><i class="fa fa-angle-right"></i>  	The promotion of mutually beneficial relations between the Organization and its Partners and </li>-->
<!--        <li><i class="fa fa-angle-right"></i>  	Promote Internal communications between the various levels and departments of the Organization</li>-->
...
<!--<h4 class="policy-name"><b>Adrian Estes  PhD</b><br>-->
<!--    Chairman<br>-->
<!--    International Board of Skills & Development -->
     
<!--    </h4>-->
<!--    <div class="clearfix"></div>-->
<!--    <br>-->
    
    <a class="btn icon-btn btn-success" href="pdf/full-policy.pdf" target="_blank"><span class="glyphicon btn-glyphicon  glyphicon-chevron-down img-circle text-success"></span> Download Our Policies 
