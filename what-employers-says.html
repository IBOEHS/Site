...
<head>
  ...
  <title>IBOEHS - WHAT EMPLOYERS SAYS</title>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                <div class="testi-wrap">
                    <!--<div class="img-part">-->
                    <!--    <img src="images/says/1.jpg" alt="">-->
                    <!--</div>-->
                    <div class="content-part new-content pt-12">
                        <div class="desc">" International Board of Environmental Health and Safety courses are unique in their content. The board has considered the inclusion of more applied health and safety topics in its syllabus. "</div>
                        <div class="info">
                            <h5 class="name">Vice President </h5>
                            <div class="designation">TPL India </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                <div class="testi-wrap">
                    ...
                    <!--</div>-->
                    <div class="content-part new-content pt-12">
                        <div class="desc">" I recommend IBOEHS safety programs to all construction professionals as their contents are more relevant to present-day construction sites. I made it compulsory for my subcontractor employees to undergo a minimum OSHA 30 hours course from IBOEHS before joining the worksite.  "</div>
                        <div class="info">
                            <h5 class="name">Kingsley Fernadez  </h5>
                            <div class="designation">Mather Highland Projects - India</div>
                        </div>
                    </div>
                </div>
            </div><!--col-md-6 col-lg-6 col-sm-12 col-xs-12-->
