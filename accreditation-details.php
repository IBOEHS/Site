...
<head>
  ...
  <title>IBOEHS - ACCREDITATION DETAILS</title>
  ...
  <div class="banner_link">
    <div class="container">
      <div class="abnner_link_inner">
        ...
        <a href=""> | </a>
        <a href="">Accreditation details</a>
      </div>
    </div>
  </div>
...
<h3>ISO 17024:2012 by The International Accreditation Services for Certification bodies (IASCB)-USA. </h3>
<p>IBOEHS is certified for ISO/IEC 17024:2012. </p>
<p>ISO/IEC 17024: Conformity assessment - General requirements for bodies operating certification of persons is an International Standard which specifies criteria for the operation of a personal Certification body (also known as a certification body for persons). The standard includes requirements for developing and maintaining the certification scheme for persons upon which the certification is based.</p>
<p>IBOEHS programs are accredited by The International Accreditation Services for Certification bodies (IASCB)-USA. </p>
<p>The International Accreditation Services for Certification Bodies (IASCB) is an alliance of organizations dedicated to assuring competency, professional management, and service to the public by encouraging and setting standards for licensing certification and credentialing programs.</p>

<p>In 1996, a group of association executives chartered the IASCB to evaluate certification programs at a reasonable rate that smaller organizations can afford. Over the years, the IASCB has developed a comprehensive process to evaluate certification programs against international standards. In this way, accredited organizations can improve existing certification programs and demonstrate to the public that their programs comply with industry best practices.</p>
<p>
...
The IASCB itself operates under the international guidelines established as a quality assurance regime for accreditation bodies (ISO/IEC 17011 â€ "Conformity Assessment: General Requirements for Accreditation Bodies Accrediting Conformity Assessment Bodies) and has established assessment tools and processes that assure certification bodies comply with ISO/IEC 17024 (2012): Conformity Assessment â€ "General Requirements for Bodies Operating Certification of Persons. </p>

<h3>Veterans Affairs </h3>
<p> The International Board of Environmental Health & Safety, Inc. individual certifications are VA approved</p>
</div>
