...
<head>
  ...
  <title>IBOEHS - EHS Audit & Certification</title>
  ...
  <div class="banner_link">
    <div class="container">
      <div class="abnner_link_inner">
        ...
        <a href=""> | </a>
        <a href="">EHS Audit & Certification</a>
      </div>
    </div>
  </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 vision-text">
                <h3 class="page-sub-title">EHS AUDIT & Certification</h3>
                <p class="text-justify">
                    The International Board of Environmental Health & Safety, Inc is keen on sharing environmental health and safety knowledge and expertise with organizations associating with it. It guides them to implement Health and safety systems and procedures through systematic Environmental Health and Safety Audits. The most comprehensive, contemporary, quantified audit process of IBOEHS allows organizations to test their health and safety performance against the latest legislation, recognized standards, and best practice techniques.
IBOEHS Onsite audit Provides a quantified outcome with detailed recommendations for improvements as per the requirements of ISO 45001:2018 

                  </p>
                  
                  <h3 class="page-sub-title">THe IBOEHS EHS audit program assess </h3>
                  
<p>1. The level and effectiveness of Management commitment and Leadership</p>
<p>2. Worker's participation and welfare measures </p>
<p>3. Planing and Risk mitigation</p>
<p>4. Organizational health and safety culture  </p>
<p>5. Continual improvement </p>




<h3 class="page-sub-title">Ideal for ? </h3>

<p>IBOEHS- EHS audit will help small, medium, and big Organisation's within any sector that is keen on </p>
<p>(a) Benchmarking their current OHS performance against best practice.</p>
<p>(b) Maintaining continual improvement concerning health and safety. </p>

<h3 class="page-sub-title">The benefits </h3>
<p>IBOEHS: EHS audit can benefit organizations in many ways. The main benefits include </p>

<p>•Cost-effective assessment and benchmarking </p>
<p>•External recognition of OHS practices </p>
<p>•	Help to demonstrate management commitment towards health and safety to stakeholders and other interested parties.</p>
<p>•	Help to improve the morale of the workforce and enhance safety performance. </p>
<p>•	A detailed audit report with the findings, quantified outcomes, with detailed recommendations.</p>
<p>•	Audit Certificate. </p>
<h3 class="page-sub-title">To book an audit, please write to us at. info@iboehs.org </h3>
