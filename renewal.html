        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="faq-strip">
                        The conditional IBOEHS accreditation is for a period of one year. The center needs to renew their annual license by remitting a fee of 250 USD every year to IBOEHS.

                    </div>
                    <div class="col-md-6 col-md-offset-3 col-xs-12 text-center">
<!--  <div class="alert alert-success fade in text-uppercase" role="alert" style="-->
<!--    background: #ba4243;-->
<!--    /* color: #fff; */-->
<!--">-->
<!--    <i class="fa fa-download alert-success" style="-->
<!--    color: #fff;-->
<!--    background: #c70f0f;-->
<!--"></i>-->
<!--    <strong><a href="pdf/centre-renewal-form.pdf" target="_blank" style="-->
<!--    color: #fff;-->
<!--"> Download</a> </strong>   -->
<!--</div>-->
</div>
